...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <ol class="round">
        ...
        <li class="three">
            <h5>关于Boot.Alert</h5>
            Boot.Alert的前身是我在网上下的一个JQuery.confirm.js，好屌的样子，打开一看，才150来行代码，而且在我的系统上用不怎么好使，尤其是当页面里含有iframe的时候。于是我就一通乱改，成了现在这样子。这虽然只是基于Bootstrap样式很小的一个插件，但是简单的东西不一定就平凡，在走向卓越之前它仍然有很大的改良空间。所以...看你的了。
        </li>
    </ol>
</asp:Content>
